...
//  public ResponseDto<?> validateNickname(MemberRequestDto requestDto) {
//    return isPresentMember(requestDto.getNickname()) == null ?
//            ResponseDto.success("사용 가능한 닉네임 입니다.") :
//            ResponseDto.fail("DUPLICATED_NICKNAME", "중복된 닉네임 입니다.");
//  }
